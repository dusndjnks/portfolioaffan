        ...
        <div className=''>
          ...
          <div className='transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110'>
            ...
            <div>
              ...
              <h1 className='lg:text-6xl md:text-5xl sm:text-4xl text-3xl underline font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-yellow-500 to-green-600'>Dress Store</h1>
        ...
        <div className=''>
          ...
          <div className='transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110'>
            ...
            <div className='pr-10'>
              ...
              <h1 className='lg:text-6xl md:text-5xl sm:text-4xl text-3xl underline  font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-green-800'>Plant Store</h1>
