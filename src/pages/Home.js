...
import Affan from "../Affan.mernstack.CV.2025.pdf"
    ...
    <Layout>
        <div className='md:flex-row justify-between flex flex-col 2xl:px-72 xl:px-56 lg:px-32 md:px-14 sm:px-20 px-5  lg:py-20 md:py-14 py-10 items-center  text-white bg-gray-800 gap-10'>
                ...
                <div className='flex flex-col'>
                    ...
                    <a href={Affan} download="Affan.MERNStack.2025.pdf" className="lg:text-2xl md:text-xl text-lg lg:px-6 md:px-4 px-3 py-2 flex items-center justify-center text-center rounded-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:bg-gradient-to-l">Download Resume</a>
